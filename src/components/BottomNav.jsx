...
const IconInicio = ({ activo }) => (
  <svg viewBox="0 0 24 24" fill="none" className="w-6 h-6" stroke={activo ? "#1A1A1A" : "#B3B3B3"} strokeWidth="2">
...
export default function BottomNav() {
  return (
    <nav className="sm:hidden fixed bottom-0 inset-x-0 z-30 bg-carbon-light border-t border-carbon-border pb-[env(safe-area-inset-bottom)]">
